...
for(var i = wormhole_segments; i > 0; i-=1;){
	...
	draw_sprite_ext(spr_wormhole,-1,phy_position_x,phy_position_y,wormhole_size * i/wormhole_segments,wormhole_size * i/wormhole_segments,rotation-i*30,color,1)
	}
