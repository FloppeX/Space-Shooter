...
particle_speed_change = random(0.04)-0.02// -0.015
...
part_type_size(wormhole_particle,1,1,-0.01,0);                   
...
part_type_life(wormhole_particle,60,60);
