...
draw_sprite_ext(sprite_index,-1,phy_position_x,phy_position_y,3,3,-phy_rotation,c_white,0.1)
draw_sprite_ext(sprite_index,-1,phy_position_x,phy_position_y,2,2,-phy_rotation,c_white,0.2)
