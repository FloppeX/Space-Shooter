...
for (var i = 0; i <= 1; i += 0.01){
	...
	part_type_orientation(wormhole_particle,rotation+100*i,rotation+100*i,0,0,1);
	part_type_color_hsv(wormhole_particle,i*100+hue,i*100+hue,255,255,255,255); 
	part_particles_create(global.part_system_below, phy_position_x+i*sprite_width, phy_position_y+i*sprite_width, wormhole_particle, 3);
	}
