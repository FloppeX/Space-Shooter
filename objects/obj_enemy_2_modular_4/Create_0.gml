...
/* module */			modules[module_number,0] = scr_create_random_enemy_2_cockpit();
...
if randomizer == 0{
	/* module */			modules[module_number,0] = instance_create_depth(x,y,-10,obj_module_engine_enemy_team_2);
	modules[module_number,0].offset_angle = 0
	}
else{
	if irandom(1) == 0
	/* module */			modules[module_number,0] = scr_create_random_enemy_device();
	else					modules[module_number,0] = scr_create_random_enemy_2_weapon();
...
if randomizer > 0{
	...
	/* module */			modules[module_number,0] = scr_create_random_enemy_2_weapon();
...
if randomizer == 0{
	...
	if irandom(1) == 0
	/* module */			modules[module_number,0] = scr_create_random_enemy_2_device();
	else					modules[module_number,0] = scr_create_random_enemy_2_weapon();
	with(modules[module_number,0]){
		var i = irandom(3)
		switch (i){
